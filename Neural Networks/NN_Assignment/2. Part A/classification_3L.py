...
# Create model
model = Sequential()
model.add(Dense(hidden_layer_1, input_dim=21, activation='relu', kernel_regularizer=l2(decay)))
...
plt.savefig('Part A/Plots/4c_plot_acc.png')
plt.show()
# Plot loss
...
plt.savefig('Part A/Plots/4c_plot_loss.png')
plt.show()
