...
wandb.init(config=defaults, resume=True, name='5 Layer Special Model', project='NN_Part_B_Redo_5')
config = wandb.config
...
model.add(Dropout(0.2))
model.add(Dense(config.hidden_layer_3, activation='relu', kernel_regularizer=l2(config.decay)))
model.add(Dropout(0.2))
